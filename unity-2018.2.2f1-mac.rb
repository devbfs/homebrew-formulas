...
class Unity201822f1Mac < Formula
  keg_only 'No linking is necessary. Anything that needs to use this will know where to find it.'

  url 'http://brew.backflipstudios.com/brew/unity-2018.2.2f1-mac.tar.gz'
  sha256 'e39f88eff7d189da356f68ee7450c6407f9a61b71eb35db12b733240d0698290'
  version '1'
