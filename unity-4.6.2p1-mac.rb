...
class Unity462p1Mac < Formula
  keg_only 'No linking is necessary. Anything that needs to use this will know where to find it.'

  url 'http://brew.backflipstudios.com/brew/unity-4.6.2p1-mac.tar.gz'
  sha1 'd3f72523236a3c48e8ba1789de7e8876d40b2662'
  version '1'
