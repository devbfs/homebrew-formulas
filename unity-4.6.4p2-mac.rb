...
class Unity464p2Mac < Formula
  keg_only 'No linking is necessary. Anything that needs to use this will know where to find it.'

  url 'http://brew.backflipstudios.com/brew/unity-4.6.4p2-mac.tar.gz'
  sha1 '598e91a716eb91c25d45d083b80fc632f000d8eb'
  version '1'
