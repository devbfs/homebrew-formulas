...
class Xcode73Mac < Formula
  ...
  def install
    ...
    system "rsync", "-a",
      ...
      "--exclude=Contents/Developer/Platforms/WatchSimulator.platform/Developer/SDKs/WatchSimulator.sdk/System/Library/Frameworks/CoreFoundation.framework/CoreFoundation",
