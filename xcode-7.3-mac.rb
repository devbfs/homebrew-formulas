...
class Xcode73Mac < Formula
  ...
  def install
    ...
    system "rsync", "-a",
      "--exclude=Contents/Developer/Applications/Simulator*",
      "--exclude=Contents/Developer/Platforms/AppleTVSimulator.platform",
      "--exclude=Contents/Applications/Application*",
      "--exclude=Contents/Developer/Library/PrivateFrameworks/CoreSimulator.framework/Versions/A/CoreSimulator",
      "--exclude=Contents/Developer/Platforms/AppleTVOS.platform",
      "--exclude=Contents/Developer/Platforms/MacOSX.platform/Developer/Library/Frameworks/XCPlayground.framework",
      "--exclude=Contents/Developer/Platforms/WatchSimulator.platform/Developer/SDKs/WatchSimulator.sdk",
