...
class Unity201836f1Mac < Formula
  keg_only 'No linking is necessary. Anything that needs to use this will know where to find it.'

  url 'http://brew.backflipstudios.com/brew/unity-2018.3.6f1-mac.tar.gz'
  sha256 '7e5d95661d274fbca91aec3939482b7c3e1b3d20d97a7aef506dadf7011dd0c2'
  version '1'
