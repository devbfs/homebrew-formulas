...
class Unity465f1Mac < Formula
  keg_only 'No linking is necessary. Anything that needs to use this will know where to find it.'

  url 'http://brew.backflipstudios.com/brew/unity-4.6.5f1-mac.tar.gz'
  sha1 'd6b6363c8bc480c9a1e6bb9b637d52f40b18ae5e'
  version '1'
