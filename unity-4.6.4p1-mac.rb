...
class Unity464p1Mac < Formula
  keg_only 'No linking is necessary. Anything that needs to use this will know where to find it.'

  url 'http://brew.backflipstudios.com/brew/unity-4.6.4p1-mac.tar.gz'
  sha1 '85f4474a3816e19dba51557f03f889d19a347809'
  version '1'
