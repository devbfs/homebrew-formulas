...
class Unity502p2Mac < Formula
  keg_only 'No linking is necessary. Anything that needs to use this will know where to find it.'

  url 'http://brew.backflipstudios.com/brew/unity-5.0.2p2-mac.tar.gz'
  sha1 'eaf0ebbc651303df23819f93e73ee5d07da022f0'
  version '1'
