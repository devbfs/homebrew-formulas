...
class Unity537f1BfsMac < Formula
  keg_only 'No linking is necessary. Anything that needs to use this will know where to find it.'

  url 'http://brew.backflipstudios.com/brew/unity-5.3.7f1-bfs-mac.tar.gz'
  sha256 'e2ae8e2d670b01b8ca3c2ec5160acd9db72828bbcb0c82b650414d5b8e051258'
  version '1'
