...
class Unity534f1BfsMac < Formula
  keg_only 'No linking is necessary. Anything that needs to use this will know where to find it.'

  url 'http://brew.backflipstudios.com/brew/unity-5.3.4f1-bfs-mac.tar.gz'
  sha256 '4e19503dbdd3e333983b63d5f0be79f8fd5b98e21294daf414d5633304640bcb'
  version '1'
