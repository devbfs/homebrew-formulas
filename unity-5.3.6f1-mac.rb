...
class Unity536f1Mac < Formula
  keg_only 'No linking is necessary. Anything that needs to use this will know where to find it.'

  url 'http://brew.backflipstudios.com/brew/unity-5.3.6f1-mac.tar.gz'
  sha256 'a04947a91bc28f85982e2c28b341076b0c35c0bef2e0ed9d19a5fbccb5bc2fb3'
  version '1'
