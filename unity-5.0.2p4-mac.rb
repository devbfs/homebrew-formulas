...
class Unity502p4Mac < Formula
  keg_only 'No linking is necessary. Anything that needs to use this will know where to find it.'

  url 'http://brew.backflipstudios.com/brew/unity-5.0.2p4-mac.tar.gz'
  sha1 '1495e64a20b54c76de1648a46e7681ec7f177cb9'
  version '1'
